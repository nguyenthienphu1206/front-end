...
const DataTable = (props) => {
    const { name, data, columns, onSelectedRows/*, currentPage, numOfPage, onPageChange, onChangeItemsPerPage, onKeySearch */} = props;
                ...
                <div className="row mb-3">
                    ...
                    <div className="col-sm-12 col-md-6">
                        <label className='d-inline-flex float-end'>Search:
                            ...
                            <input type="search" className="form-control form-control-sm ms-1" placeholder="Name"/>
                        </label>
                    </div>
                </div>
